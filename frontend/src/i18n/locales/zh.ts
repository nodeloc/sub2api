export default {
  ...
  home: {
    ...
    landing: {
      ...
      logos: {
        eyebrow: '每个主流厂商，统一一个接口'
      },
      how: {
        title: '就三件事',
        subtitle: 'KISS —— Keep It Simple, Stupid（保持简单）。',
        step1Title: '一个密钥',
        step1Desc: '注册即得一个密钥，适用于目录中的每一个模型。',
        step2Title: '一个请求',
        step2Desc: '指定一个模型——或让它自动路由到最便宜且能通过你提示词的那个。',
        step3Title: '一份账单',
        step3Desc: '只为实际用掉的 token 付费，跨所有厂商，从一个预付余额中扣除。'
      },
      models: {
        title: '从最好的之中挑选',
        subtitle: '实时价格、状态与上下文——随时切换，无需改代码。',
        browseAll: '浏览全部 240 个',
        input: '输入',
        output: '输出',
        ctx: '上下文',
        status: {
        ...
        items: {
          claudeOpus: { desc: '前沿推理、视觉与长上下文，最适合攻克难题。' },
          gpt5: { desc: '广泛的通用智能，强大的工具调用与编码能力。' },
          llama4: { desc: '开源权重主力——大规模场景下极佳的性价比。' },
          gemini25: { desc: '百万级上下文与快速的多模态理解。' },
          mistralLarge: { desc: '高效的欧洲模型，强多语言与 JSON 模式。' },
          deepseekR1: { desc: '开源推理模型，思维链可见。' }
        }
      },
      code: {
        badge: '即插即用',
        title: '已经会用 OpenAI 的 API？那就够了。',
        desc: '把 base URL 指向 {name}，沿用你现有的 SDK，指定任意模型即可。无需重写，无需更换客户端。',
        copyKey: '复制你的密钥'
      },
      pricing: {
        title: '简单的按量计费',
        subtitle: '无最低消费。无加价套路。随时取消。',
        mostPopular: '最受欢迎',
        payg: {
          name: '按量付费',
          price: '$0',
          note: '/ 月',
          cta: '免费开始',
          feats: ['只为用掉的 token 付费', '全部 240+ 模型', '1 个工作区', '社区支持']
        },
        team: {
          name: '团队版',
          price: '$20',
          note: '/ 席位 / 月',
          cta: '开通团队版',
          feats: ['包含按量付费全部功能', '共享余额与预算', '用量分析与告警', '优先路由']
        },
        enterprise: {
          name: '企业版',
          price: '定制',
          note: '',
          cta: '联系我们',
          feats: ['SSO 与 SCIM', '专属容量', 'SLA 与支持', '私有化路由']
        }
      },
      cta: {
        title: '今天就用上每一个模型',
        subtitle: '免费起步。一个密钥。无需信用卡。',
        createAccount: '创建免费账户',
        readDocs: '阅读文档'
      },
      footer: {
        tagline: '一个 API，畅用所有 AI 模型。保持简单。',
        product: '产品',
        developers: '开发者',
        company: '公司',
        about: '关于',
  ...
  // Auth
  guardrails: {
    intro: '作用于你用量的消费上限与限流规则。',
    spendLimits: '消费上限',
    payg: '按量付费 —— 从余额扣费，无订阅上限。',
    rateLimits: 'API 密钥限流',
    rateLimitsBody: '每个密钥在滚动窗口内的 token 限额。',
    noRateLimits: '未设置任何密钥限流。',
    allowedGroups: '可用分组',
  },
  marketing: {
    footer: {
      tag: '一个 API,接入所有 AI 模型。保持简单。',
      productHead: '产品',
      devHead: '开发者',
      companyHead: '公司',
      playground: '体验场',
    ...
    pricing: {
      heroBadge: '不加价 · 随时取消',
      heroTitle: '简单的按量计费',
      heroSub: '免费起步,只为你使用的 token 付费。需要更多时再升级 Team 套餐。',
      mostPopular: '最受欢迎',
      paygName: '按量付费',
      paygNote: '/ 月',
      startFree: '免费开始',
      paygFeats: '只为使用的 token 付费\n全部可用模型\n1 个工作区\n社区支持',
      enterpriseName: '企业版',
      enterprisePrice: '定制',
      talkToUs: '联系我们',
      enterpriseFeats: 'SSO 与 SCIM\n专属容量\nSLA 与支持\n定制数据策略',
      teamName: 'Team',
      teamNote: '/ 30 天',
      teamCta: '开通 Team',
      teamDesc: '为成长中的团队打造。一把密钥用遍所有 Claude 模型,按 Claude 方式逐 token 计费。',
      teamFeats: '包含按量付费的全部能力\nClaude 式逐 token 计费\n缓存读取 0.1× · 写入 1.25×/2×\n长上下文阶梯定价\n优先路由',
      startPlan: '开通 {name}',
      ruleHead: 'Team 计费规则',
      ruleLead: 'Team 套餐的用量按 token 计量,参照 Claude 的定价模型。',
      ruleInOutK: '输入 / 输出 token',
      ruleInOutV: '按每个模型的费率逐 token 计费(如 Opus 每 100 万 $5 / $25)',
      ruleCacheWriteK: '缓存写入',
      ruleCacheWriteV: '1.25× 输入(5 分钟 TTL)· 2× 输入(1 小时 TTL)',
      ruleCacheReadK: '缓存读取',
      ruleCacheReadV: '0.1× 输入',
      ruleBatchK: '批量请求',
      ruleBatchV: '0.5×(5 折)',
      ruleLongK: '长上下文(>200K)',
      ruleLongV: '高级档(约 2× 输入/输出)',
      tokensHead: '逐 token 费率',
      tokensLead: 'Team 套餐各模型的计费。价格以每百万 token 计。',
      thModel: '模型',
      thContext: '上下文',
      thInput: '输入 / M',
      thOutput: '输出 / M',
      faqHead: '常见问题',
      faq1Q: 'Team 计费是怎么算的?',
      faq1A: '固定 $20 / 30 天的订阅解锁 Team 分组;之后用量按上面的 Claude 式规则逐 token 计量,从你的余额中扣除。',
      faq2Q: 'token 会加价吗?',
      faq2A: '逐 token 费率对标 Claude 自家定价 —— 输入/输出加上缓存与长上下文分档,没有隐藏的逐 token 加价。',
      faq3Q: '某个供应商挂了会怎样?',
      faq3A: '开启故障转移路由后,请求会自动重新路由到该模型的下一个健康上游。',
      faq4Q: '可以设置消费上限吗?',
      faq4A: '可以 —— 按分组的日/周/月美元上限、低余额提醒,以及可选的硬性停用。',
    },
    docs: {
      sideHead: '快速开始',
      navQuickstart: '快速开始',
      ...
      badge: '快速开始',
      h1: '发起你的第一个请求',
      intro: '它兼容 OpenAI API。把 base URL 指向我们,保留你的 SDK,调用 240+ 模型中的任意一个,一分钟内即可跑起来。',
      alertTitle: '一把密钥,所有模型',
      alertBody: '已经在用 OpenAI SDK?改两行 —— {base} 和 {key} —— 就好了。',
      authH2: '鉴权',
      authP: '在控制台创建一把密钥,然后作为 Bearer token 发送。请妥善保存在服务端。',
      firstH2: '第一个请求',
      firstP: '一个最简的对话补全。{model} 字段就是你的路由决策 —— 改这一个字符串即可切换模型。',
      streamingH2: '流式响应',
      streamingP: '设置 {stream} 即可在 token 生成时接收 server-sent events。',
      routingH2: '模型路由',
      routingP: '{model} 字符串就是你的路由决策 —— 改这一个字段即可切换模型、供应商和上游账号。网关会自动为该模型挑选健康的上游。',
      sdksH2: 'SDK',
      sdksP: '使用原生 OpenAI SDK,或我们的轻量封装。所有模型的请求结构一致。',
      getKey: '获取 API 密钥',
      browseModels: '浏览模型',
    },
    about: {
      badge: '我们的使命',
      title1: '让每一个 AI 模型都能从',
      title2: '同一个简单的地方接入。',
      intro: 'kissopen 源于一个痛点:每家供应商都有自己的密钥、计费和 SDK。我们认为网关应该无聊、公平、极简 —— 让开发者把时间花在产品上,而不是管线上。',
      storyHead: '我们为什么做它',
      story1: '能用的模型越来越多 —— 但同时用好几个就意味着要周旋于多个账号、密钥、限流和账单。团队一遍又一遍地写同样的路由和兜底胶水代码。',
      story2: '我们把 kissopen 做成我们希望存在的那一层:一个兼容 OpenAI 的统一端点,挡在所有供应商前面,一个预付费余额,诚实的逐 token 定价。指定一个模型,或让我们路由到能通过的最便宜的那个 —— 就这么简单。',
      story3prefix: '名字已经说明一切:',
      story3kiss: 'kiss',
      story3kissText: ' 取自 Keep It Simple, Stupid(大道至简),而 ',
      story3open: 'open',
      story3openText: ' 代表对所有 AI 的开放接入。两个圆,相交于一点。',
      valuesHead: '我们的价值观',
      v1t: '保持简单',
      v1d: '一把密钥、一个余额、一套心智模型。每个功能都必须证明自己比"能用的最简版本"更值得存在。',
      v2t: '保持开放',
      v2d: '不绑定、不偏袒。前沿模型与开源权重模型并列;你来选,随时切换。',
      v3t: '默认公平',
      v3d: '你按供应商的费率付费,路由透明。没有加价游戏、没有最低消费、没有意外账单。',
      v4t: '开发者优先',
      v4d: '我们是为开发者做产品的开发者。文档差、SDK 难用,那就是 bug。',
      ctaTitle: '想一起来做吗?',
      ctaSub: '我们保持小团队、开放的路线图。',
      ctaRoles: '查看空缺职位',
      ctaContact: '联系我们',
    },
    careers: {
      badge: '加入我们',
      title: '帮我们把 AI 做得简单又开放。',
      intro: '我们是一支精干的资深团队,打造每个 AI 开发者都会用到的网关 —— 那套让其它一切成为可能的、无聊而优雅的管线。',
      p1t: '远程优先',
      p1d: '在哪都能工作。我们看重协作时段的重叠,而非地点。',
      p2t: '真正的归属',
      p2d: '有意义的股权,以及透明、行业上游的薪资。',
      p3t: '模型预算',
      p3d: '每月慷慨的额度,用我们提供的每一个模型来构建。',
      p4t: '小而快',
      p4d: '小团队、短会议、上手即发布的文化。',
      rolesHead: '空缺职位',
      noRolesTitle: '目前暂无空缺职位',
      noRolesBody: '我们当前没有在大规模招聘 —— 但我们始终乐于结识优秀的人。',
      sayHello: '打个招呼 →',
    },
    blog: {
      title: '博客',
      sub: '关于路由、定价、模型,以及用 kissopen 构建的笔记。',
      emptyTitle: '还没有文章',
      emptyBody: '工程笔记、产品更新和指南正在路上,敬请期待。',
    },
    changelog: {
      title: '更新日志',
      sub: 'kissopen 的新变化。持续发布,在此汇总。',
      runningOn: '当前版本',
      emptyTitle: '更新日志即将上线',
      emptyBody: '这里将展示汇总后的更新日志。目前,更新会持续发布。',
    },
    contact: {
      title: '联系我们',
      sub: '关于 kissopen、定价或合作有疑问?给我们留言 —— 我们每一条都会看。',
      c1t: '销售',
      c1d: '咨询定价、批量折扣与企业版。',
      c2t: '支持',
      c2d: '账号、计费与 API 问题。',
      ...
      topicPress: '媒体',
      formMessage: '留言',
      formMessagePlaceholder: '我们能帮你什么?',
      send: '发送留言',
      sending: '发送中…',
      sentTitle: '谢谢 —— 留言已准备好',
      sentBody: '你的邮件客户端应该会打开并预填好内容。如果没有,请直接邮件联系我们。',
      sendAnother: '再写一条',
    },
    status: {
      title: '系统状态',
      operational: '所有系统运行正常',
      operationalSub: 'kissopen 的实时服务健康状况。',
      componentsHead: '组件',
      cGateway: 'API 网关',
      cRouting: '模型路由',
      cPlayground: '体验场',
      ...
      incidentsHead: '历史事件',
      noIncidentsTitle: '暂无事件报告',
      noIncidentsBody: '当前没有需要报告的事件。任何服务中断都会发布在这里。',
    },
  },
  credits: {
    title: '额度',
    ...
    payTitle: '完成支付',
    creditedAfter: '到账额度',
    rechargeDisabled: '当前暂不支持充值。',
    redeemCode: '有兑换码？',
    redeemSub: '输入礼品 / 兑换码,把额度充值到你的余额。',
    redeemPlaceholder: '请输入兑换码',
    redeemSubmit: '兑换',
    redeeming: '兑换中…',
    redeemSuccess: '已兑换 +${v} 到余额!',
    redeemFailed: '该兑换码无法兑换。',
    spentTotal: '累计消费',
    today: '今日',
    howBilling: '计费说明',
    howBillingBody: '额度为预付费，可用于所有模型与供应商。按原生 token 计费，不在供应商价格上加价。',
    transactions: '交易记录',
    creditPurchase: '额度充值',
    subscription: '订阅',
    noSubscription: '暂无订阅',
  ...
  pro: {
    title: '升级 Pro',
    sub: '升级到 Team 套餐 —— 一个密钥畅享所有 Claude 模型，按 Claude 式 token 计费。',
    active: '生效中',
    yourPlan: '你的套餐',
    usageThisMonth: '本月用量',
    usageThisWeek: '本周',
    ...
    free: '免费',
    payg: '按量付费',
    upgradeHint: '你当前在免费的按量付费档。订阅下方套餐可获得更多。',
    recommended: '推荐',
    subscribe: '立即订阅',
    viewPlans: '查看套餐',
    noPlans: '当前暂无可订阅套餐。',
    ...
    resetsIn: '重置于',
    billingRule: '计费规则',
    billingRuleSub: '用量按 token 计费，参考 Claude 的计费方式。',
    ruleInOut: '输入 / 输出 token',
    ruleInOutV: '按各模型费率计（如 Opus 每百万 $5 / $25）',
    ruleCacheWrite: '缓存写',
    ruleCacheRead: '缓存读',
    ruleBatch: '批量 / flex 请求',
    ruleLongCtx: '长上下文 (>200K)',
    ruleLongCtxV: '溢价档（约 2× 输入/输出）',
  },
  models: {
    sub: '你的账户可调用 {n} 个模型。',
    lead: '{n} 个模型 · 一个 API 密钥全部通用',
    available: '个可用',
    operational: '正常',
    allModels: '全部模型',
  ...
  playground: {
    stream: '流式',
    blank: '选择密钥和模型，然后开始提问。',
    placeholder: '随便问点什么…（回车发送）',
    send: '发送',
    hint: '回车发送 · Shift+回车换行',
    clear: '清空',
    empty: '（空响应）',
    noKeys: '还没有 API 密钥 —— 请先创建一个。',
    noModels: '该密钥下没有可用模型。',
    errKeys: '加载 API 密钥失败。',
    errSend: '请求失败。',
  },
  ...
  auth: {
    brandQuote: '大道至简，开放一切 AI。',
    brandSub: '一个 API 密钥、一份余额，畅享所有前沿与开源模型。登录即可继续未完成的工作。',
    statModels: '模型',
    statKey: '密钥与余额',
    statUptime: '路由可用率',
    welcomeBack: '欢迎回来',
  ...
  keys: {
    ...
    unlimited: '不限额',
    secretTitle: '请妥善保管密钥',
    secretBody: '请像对待密码一样对待密钥。一旦泄露请及时轮换；吊销将立即生效。',
    firstRequest: '发起你的第一个请求',
  ...
  usage: {
    title: '使用记录',
    rankingsSub: '在所选时间范围内按用量对模型排名。',
    providersSub: '你的用量在各上游供应商之间的分布情况。',
