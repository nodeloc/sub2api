export default {
  ...
  home: {
    ...
    landing: {
      ...
      hero: {
        badge: '240+ models · one balance',
        titleLine1: 'Keep it simple.',
        titleLine2: 'Open all AI.',
        subtitle:
      ...
      stats: {
        ...
        uptime: 'routed uptime',
        lockin: 'lock-in'
      },
      logos: {
        eyebrow: 'Every major provider, one endpoint'
      },
      how: {
        title: "Three things, that's it",
        subtitle: 'KISS — Keep It Simple, Stupid.',
        step1Title: 'One key',
        step1Desc: 'Sign up and get a single key that works with every model in the catalogue.',
        step2Title: 'One request',
        step2Desc: 'Name a model — or let it auto-route to the cheapest that passes your prompt.',
        step3Title: 'One bill',
        step3Desc: 'Pay only for tokens used, across all providers, from one prepaid balance.'
      },
      models: {
        title: 'Pick from the best',
        subtitle: 'Live pricing, status and context — switch any time without code changes.',
        browseAll: 'Browse all 240',
        input: 'Input',
        output: 'Output',
        ctx: 'ctx',
        status: {
        ...
        items: {
          claudeOpus: { desc: 'Frontier reasoning, vision and long context. Best for hard problems.' },
          gpt5: { desc: 'Broad general intelligence with strong tool use and coding.' },
          llama4: { desc: 'Open-weight workhorse — great price-to-performance for scale.' },
          gemini25: { desc: 'Million-token context and fast multimodal understanding.' },
          mistralLarge: { desc: 'Efficient European model, strong multilingual + JSON modes.' },
          deepseekR1: { desc: 'Open reasoning model with visible chain-of-thought.' }
        }
      },
      code: {
        badge: 'Drop-in',
        title: "Already know OpenAI's API? You're done.",
        desc: 'Point your base URL at {name}, keep your existing SDK, and name any model. No rewrites, no new client.',
        copyKey: 'Copy your key'
      },
      pricing: {
        title: 'Simple, usage-based pricing',
        subtitle: 'No minimums. No markup games. Cancel anytime.',
        ...
        payg: {
          ...
          note: '/ month',
          cta: 'Start free',
          feats: ['Only pay for tokens used', 'All 240+ models', '1 workspace', 'Community support']
        },
        team: {
          name: 'Team',
          price: '$20',
          note: '/ seat / mo',
          cta: 'Start Team',
          feats: ['Everything in PAYG', 'Shared balance & budgets', 'Usage analytics & alerts', 'Priority routing']
        },
        enterprise: {
          name: 'Enterprise',
          price: 'Custom',
          note: '',
          cta: 'Talk to us',
          feats: ['SSO & SCIM', 'Dedicated capacity', 'SLA & support', 'On-prem routing']
        }
      },
      cta: {
        title: 'Start with every model today',
        subtitle: 'Free to start. One key. No card required.',
        createAccount: 'Create free account',
        readDocs: 'Read the docs'
      },
      footer: {
        tagline: 'One API for every AI model. Keep it simple.',
        product: 'Product',
  ...
  logs: {
    ...
    requests: 'requests',
    noData: 'No activity',
    noRecords: 'No request logs in this range.',
  ...
  // Auth
  guardrails: {
    intro: 'The spend caps and rate limits that apply to your usage.',
    spendLimits: 'Spend limits',
    payg: "Pay as you go — billed from your balance, no subscription caps.",
    rateLimits: 'API key rate limits',
    rateLimitsBody: 'Per-key token limits over rolling windows.',
    noRateLimits: 'No per-key rate limits set.',
    allowedGroups: 'Allowed groups',
  },
  marketing: {
    footer: {
      tag: 'One API for every AI model. Keep it simple.',
      productHead: 'Product',
      devHead: 'Developers',
      companyHead: 'Company',
      playground: 'Playground',
      ...
      copy: 'Keep It Simple, Stupid.',
    },
    pricing: {
      heroBadge: 'No markup · cancel anytime',
      heroTitle: 'Simple, usage-based pricing',
      heroSub: 'Start free and pay only for the tokens you use. Add the Team plan when you need more.',
      mostPopular: 'Most popular',
      paygName: 'Pay as you go',
      paygNote: '/ month',
      startFree: 'Start free',
      paygFeats: 'Only pay for tokens used\nAll available models\n1 workspace\nCommunity support',
      enterpriseName: 'Enterprise',
      enterprisePrice: 'Custom',
      talkToUs: 'Talk to us',
      enterpriseFeats: 'SSO & SCIM\nDedicated capacity\nSLA & support\nCustom data policies',
      teamName: 'Team',
      teamNote: '/ 30 days',
      teamCta: 'Start Team',
      teamDesc: 'For growing teams. One key for every Claude model, billed Claude-style per token.',
      teamFeats: 'Everything in Pay as you go\nClaude-style per-token billing\nCache read 0.1× · write 1.25×/2×\nLong-context tiered pricing\nPriority routing',
      startPlan: 'Start {name}',
      ruleHead: 'Team billing rule',
      ruleLead: "Usage on the Team plan is metered per token, modeled on Claude's pricing.",
      ruleInOutK: 'Input / output tokens',
      ruleInOutV: "Per token at each model's rate (e.g. Opus $5 / $25 per 1M)",
      ruleCacheWriteK: 'Cache write',
      ruleCacheWriteV: '1.25× input (5-min TTL) · 2× input (1-hour TTL)',
      ruleCacheReadK: 'Cache read',
      ruleCacheReadV: '0.1× input',
      ruleBatchK: 'Batch requests',
      ruleBatchV: '0.5× (50% off)',
      ruleLongK: 'Long context (>200K)',
      ruleLongV: 'Premium tier (≈2× input/output)',
      tokensHead: 'Per-token rates',
      tokensLead: 'What the Team plan charges per model. Prices per million tokens.',
      thModel: 'Model',
      thContext: 'Context',
      thInput: 'Input / M',
      thOutput: 'Output / M',
      faqHead: 'Questions',
      faq1Q: 'How does Team billing work?',
      faq1A: 'A fixed $20 / 30-day subscription unlocks the Team group; usage is then metered per token using the Claude-style rule above, drawn from your balance.',
      faq2Q: 'Is there a markup on tokens?',
      faq2A: "The per-token rates mirror Claude's own pricing — input/output plus cache and long-context tiers. No hidden per-token margin.",
      faq3Q: 'What happens if a provider goes down?',
      faq3A: 'With fallback routing on, requests re-route to the next healthy upstream for that model automatically.',
      faq4Q: 'Can I set spend limits?',
      faq4A: 'Yes — per-group daily/weekly/monthly USD caps, low-balance alerts, and an optional hard stop.',
    },
    docs: {
      sideHead: 'Get started',
      navQuickstart: 'Quickstart',
      navAuth: 'Authentication',
      navFirst: 'First request',
      navStreaming: 'Streaming',
      navRouting: 'Model routing',
      navSdks: 'SDKs',
      badge: 'Quickstart',
      h1: 'Make your first request',
      intro: "It speaks the OpenAI API. Point your base URL at us, keep your SDK, and name any of 240+ models. You'll be running in under a minute.",
      alertTitle: 'One key, every model',
      alertBody: "Already using the OpenAI SDK? Change two lines — {base} and {key} — and you're done.",
      authH2: 'Authentication',
      authP: 'Create a key in the dashboard, then send it as a Bearer token. Keep it server-side.',
      firstH2: 'First request',
      firstP: 'A minimal chat completion. The {model} field is your routing decision — switch models by changing this one string.',
      streamingH2: 'Streaming',
      streamingP: 'Set {stream} to receive server-sent events as tokens are generated.',
      routingH2: 'Model routing',
      routingP: 'The {model} string is your routing decision — switch models, providers and upstream accounts by changing this one field. The gateway picks a healthy upstream for that model automatically.',
      sdksH2: 'SDKs',
      sdksP: 'Use the native OpenAI SDKs, or our thin wrappers. Same request shape across every model.',
      getKey: 'Get an API key',
      browseModels: 'Browse models',
    },
    about: {
      badge: 'Our mission',
      title1: 'Make every AI model reachable from ',
      title2: 'one simple place.',
      intro: "kissopen started with a frustration: every provider has its own keys, billing, and SDK. We thought the gateway should be boring, fair, and dead simple — so builders can spend their time on the product, not the plumbing.",
      storyHead: 'Why we built it',
      story1: 'The number of capable models keeps exploding — but using more than one means juggling accounts, keys, rate limits and invoices. Teams write the same routing and fallback glue over and over.',
      story2: 'We built kissopen as the layer we wished existed: a single OpenAI-compatible endpoint in front of every provider, with one prepaid balance and honest, per-token pricing. Name a model, or let us route to the cheapest one that passes — that is the whole idea.',
      story3kiss: 'kiss',
      story3kissText: ' for Keep It Simple, Stupid, and ',
      story3open: 'open',
      story3openText: ' for open access to all AI. Two circles, meeting at one point.',
      story3prefix: 'The name says it: ',
      valuesHead: 'What we value',
      v1t: 'Keep it simple',
      v1d: 'One key, one balance, one mental model. Every feature has to earn its place against the simplest version that works.',
      v2t: 'Stay open',
      v2d: 'No lock-in, no favourites. Frontier and open-weight models sit side by side; you pick, you switch, any time.',
      v3t: 'Fair by default',
      v3d: "You pay providers' rates with transparent routing. No markup games, no minimums, no surprise bills.",
      v4t: 'Builders first',
      v4d: "We're developers building for developers. If the docs are bad or the SDK is clunky, that's a bug.",
      ctaTitle: 'Want to help build it?',
      ctaSub: 'We keep the team small and the roadmap open.',
      ctaRoles: 'See open roles',
      ctaContact: 'Contact us',
    },
    careers: {
      badge: 'Careers',
      title: 'Help keep AI simple and open.',
      intro: "We're a small, senior team building the gateway every AI developer reaches for — the boring, beautiful plumbing that makes everything else possible.",
      p1t: 'Remote-first',
      p1d: 'Work from anywhere. We optimise for overlap, not location.',
      p2t: 'Real ownership',
      p2d: 'Meaningful equity and transparent, top-of-band salaries.',
      p3t: 'Model budget',
      p3d: 'A generous monthly credit to build with every model we offer.',
      p4t: 'Small & fast',
      p4d: 'Tiny team, short meetings, ship-on-day-one culture.',
      rolesHead: 'Open roles',
      noRolesTitle: 'No open roles right now',
      noRolesBody: "We're not actively hiring at the moment — but we're always glad to meet sharp people.",
      sayHello: 'Say hello →',
    },
    blog: {
      title: 'Blog',
      sub: 'Notes on routing, pricing, models and building with kissopen.',
      emptyTitle: 'No posts yet',
      emptyBody: 'Engineering notes, product updates and guides are on the way. Check back soon.',
    },
    changelog: {
      title: 'Changelog',
      sub: "What's new in kissopen. Shipped continuously, summarised here.",
      runningOn: 'Currently running',
      emptyTitle: 'Release notes coming soon',
      emptyBody: 'A summarised changelog will live here. For now, updates ship continuously.',
    },
    contact: {
      title: 'Get in touch',
      sub: 'Questions about kissopen, pricing, or a partnership? Send us a note — we read everything.',
      c1t: 'Sales',
      c1d: 'Talk pricing, volume discounts and Enterprise.',
      c2t: 'Support',
      c2d: 'Account, billing and API questions.',
      c3t: 'Partnerships',
      c3d: 'Integrations, resellers and press.',
      formName: 'Name',
      formEmail: 'Email',
      formCompany: 'Company',
      formTopic: 'Topic',
      topicSales: 'Sales & pricing',
      topicSupport: 'Technical support',
      topicPartner: 'Partnerships',
      topicPress: 'Press',
      formMessage: 'Message',
      formMessagePlaceholder: 'How can we help?',
      send: 'Send message',
      sending: 'Sending…',
      sentTitle: 'Thanks — message ready',
      sentBody: 'Your mail client should open with the message pre-filled. If not, email us directly.',
      sendAnother: 'Write another',
    },
    status: {
      title: 'System status',
      operational: 'All systems operational',
      operationalSub: 'Live service health for kissopen.',
      ...
      incidentsHead: 'Past incidents',
      noIncidentsTitle: 'No incidents reported',
      noIncidentsBody: 'There are no incidents to report. We will post any disruptions here.',
    },
  },
  credits: {
    title: 'Credits',
    ...
    creditedAfter: 'Credited to balance',
    rechargeDisabled: 'Top-ups are currently unavailable.',
    redeemCode: 'Have a redeem code?',
    redeemSub: 'Enter a gift / redeem code to add credits to your balance.',
    redeemPlaceholder: 'Enter code',
    redeemSubmit: 'Redeem',
    redeeming: 'Redeeming…',
    redeemSuccess: 'Redeemed +${v} to your balance!',
    redeemFailed: 'Could not redeem this code.',
    spentTotal: 'Spent · all time',
    today: 'Today',
    howBilling: 'How billing works',
    howBillingBody: "Credits are prepaid and used across every model and provider. You're billed on native token counts — no markup on provider prices.",
  ...
  pro: {
    title: 'Go Pro',
    sub: 'Upgrade to a Team plan — one key for every Claude model, billed Claude-style per token.',
    active: 'Active',
    yourPlan: 'Your plan',
    usageThisMonth: 'Usage this month',
    usageThisWeek: 'This week',
    renews: 'Renews',
    never: 'Never',
    manage: 'Manage subscription',
    free: 'Free',
    payg: 'Pay as you go',
    upgradeHint: "You're on the free pay-as-you-go tier. Subscribe to a plan below for more.",
    ...
    billingRuleSub: 'Usage is metered per token, modeled on Claude\'s pricing.',
    ruleInOut: 'Input / output tokens',
    ruleInOutV: "Per token at each model's rate (e.g. Opus $5 / $25 per 1M)",
    ruleCacheWrite: 'Cache write',
    ruleCacheRead: 'Cache read',
    ruleBatch: 'Batch / flex requests',
    ruleLongCtx: 'Long context (>200K)',
    ruleLongCtxV: 'Premium tier (≈2× input/output)',
  },
  models: {
    sub: '{n} models available to your account.',
    lead: '{n} models · one API key for all of them',
    available: 'available',
    operational: 'Operational',
  ...
  playground: {
    stream: 'Stream',
    blank: 'Pick a key and model, then ask anything.',
    placeholder: 'Ask anything…  (Enter to send)',
    send: 'Send',
    hint: 'Enter to send · Shift+Enter for newline',
    clear: 'Clear',
    empty: '(empty response)',
    noKeys: 'No API keys — create one first.',
    noModels: 'No models for this key.',
    errKeys: 'Failed to load API keys.',
  ...
  presets: {
    ...
    name: 'Name',
    namePlaceholder: 'email-copywriter',
    model: 'Model',
  ...
  auth: {
    brandQuote: 'Keep it simple. Open all AI.',
    brandSub: 'One API key and one balance for every frontier and open model. Sign in to pick up where you left off.',
    statModels: 'models',
    statKey: 'key & balance',
    statUptime: 'routed uptime',
  ...
  keys: {
    title: 'API Keys',
    lead: 'Use one key with any model.',
    revoke: 'Revoke',
    never: 'Never used',
    unlimited: 'Unlimited',
    secretTitle: 'Keep keys secret',
    secretBody: 'Treat keys like passwords. Rotate them if exposed; revoking is instant.',
  ...
  usage: {
    title: 'Usage Records',
    rankingsSub: 'Models ranked by usage across your selected range.',
    providersSub: 'How your usage is distributed across upstream providers.',
